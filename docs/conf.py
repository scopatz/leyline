...
from leyline import __version__ as LEYLINE_VERSION
...
version = LEYLINE_VERSION.rsplit('.',1)[0]

# The full version, including alpha/beta/rc tags.
release = LEYLINE_VERSION
...
# of the sidebar.
html_logo = '_static/leyline-logo.png'

# The name of an image file (within the static path) to use as favicon of the
# docs.  This file should be a Windows icon file (.ico) being 16x16 or 32x32
# pixels large.
html_favicon = '_static/leyline-logo.ico'
...
latex_documents = [
  ('index', 'fixie.tex', u'leyline documentation',
...
USAGE = """Leyline Command Line Usage
==========================
...
""" + textwrap.indent(subprocess.check_output(
        ['leyline', '--help'], universal_newlines=True), '    ')
